...
/**
 * Mesma configuração de apps/trigger/src/trigger/storage.ts e
 * apps/api/src/integrations/storage.ts — reimplementado aqui pela mesma
 * razão do resto desta variante (ver docs/07-deploy-vercel.md, seção
